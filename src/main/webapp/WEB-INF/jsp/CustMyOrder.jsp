  ...
  <rect x="9" y="14" width="6" height="6"/>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuMen">
                                            ...
                                            <li><a class="dropdown-item" href="myorder">My Order</a></li>
                                              <li><a class="dropdown-item" href="men/shoe">Setting</a></li>
  ...
  <div class="container">
            ...
            <table class="table">
                ...
                <c:forEach items="${order}" var="order">
                    <tr>
                        <td>
                            <img src="../../static/allimage/${order.p.image }" alt="Product Image" class="card-img-top" width="100" style="width: 20%">
                        </td>
                    <div style="border: 1px black;">
                        <td class="card-title">${order.p.name}</td>
                        <td class="card-title">${order.p.price}</td>
                        <td>
                        ...
                        <td>${order.p.price * order.quantity}</td>
                       <td>${order.status }</td>
